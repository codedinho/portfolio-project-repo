...
const projects = [
  {
    ...
    `,
    imageUrl: "/portfolio-project/imgs/guess-this-pic-2.jpg",
  ...
  },
  {
    ...
    imageUrl: "/portfolio-project/imgs/ai-assistant-app-pic-1.jpg",
  ...
  },
  {
    ...
    imageUrl: "/portfolio-project/imgs/em-powertools-pic-1.jpg",
  ...
  },
  {
    ...
    imageUrl: "/portfolio-project/imgs/idle-conflict-pic-1.jpg",
              ...
              <div style={styles.projectTextContainer}>
                ...
                <div style={styles.buttonsContainer}>
                  <a href={project.sourceCode} target="_blank" rel="noopener noreferrer">
                    <img
                      src="/portfolio-project/public/icons/github.png"
                      alt="Source Code"
                      style={styles.icon}
                      onMouseOver={(e) => (e.currentTarget.src = '/portfolio-project/icons/github-hover.png')}
                      onMouseOut={(e) => (e.currentTarget.src = '/portfolio-project/public/icons/github.png')}
                    />
                  </a>
                  <a href={project.websiteLink} target="_blank" rel="noopener noreferrer">
                    <img
                      src="/portfolio-project/public/icons/websitelink.png"
                      alt="Website Link"
                      style={styles.icon}
                      onMouseOver={(e) => (e.currentTarget.src = '/portfolio-project/public/icons/websitelink-hover.png')}
                      onMouseOut={(e) => (e.currentTarget.src = '/portfolio-project/public/icons/websitelink.png')}
                    />
                  </a>
